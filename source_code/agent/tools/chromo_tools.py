...
from source_code.api.config import  images_dir
...
def remove_background_of_original_image(image_path: str) -> str:
    ...
    with open(image_path, 'rb') as f:
        ...
        if response.status_code == 200:
            ...
            img_save_path = os.path.join(images_dir, f"mid_img_{uuid.uuid4().hex}.jpg")
...
def segment_mid_image(image_path: str) -> str:
    ...
    with open(image_path, 'rb') as f:
        ...
        if response.status_code == 200:
            ...
            img_save_path = os.path.join(images_dir, f"seg_mid_img_{uuid.uuid4().hex}.jpg")
            ...
            for i, cv_224_img in enumerate(cv_224_img_list):
                ...
                seg_img_save_path = os.path.join(images_dir, f"seg_224_{random_str}.jpg")
